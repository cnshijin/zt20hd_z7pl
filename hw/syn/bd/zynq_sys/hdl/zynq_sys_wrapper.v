...
//Date        : Fri Sep 08 15:23:33 2017
//Host        : PC-20160510BTZI running 64-bit Service Pack 1  (build 7601)
...
module zynq_sys_wrapper
  ...
  output hdmi_out_hblank;
  output hdmi_out_hsync;
  output hdmi_out_vblank;
  ...
  wire hdmi_out_field;
  wire hdmi_out_hblank;
  wire hdmi_out_hsync;
  wire hdmi_out_vblank;
  wire hdmi_out_vsync;
  ...
  zynq_sys zynq_sys_i
       (.DDR_addr(DDR_addr),
        ...
        .hdmi_out_hblank(hdmi_out_hblank),
        .hdmi_out_hsync(hdmi_out_hsync),
        .hdmi_out_vblank(hdmi_out_vblank),
